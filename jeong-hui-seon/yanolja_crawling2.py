...
driver.get('https://www.yanolja.com/reviews/domestic/1000099626')
...
# 최종 결과
df_reviews.to_excel('./res/crawling2/suncheon.xlsx', index=False)

with open('./res/crawling2/suncheon.csv', 'w', newline='', encoding='utf-8') as csvfile:
    fieldnames = ['review','stars','date']
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    writer.writeheader()
    for item in Jdata:
        writer.writerow(item)
with open('./res/crawling2/suncheon.json', 'w', encoding='utf-8') as jsonfile:
