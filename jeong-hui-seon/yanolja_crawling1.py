...
# 최종 결과
df_reviews.to_excel('./res/crawling1/jeju_marevo.xlsx', index=False)

with open('./res/crawling1/jeju_marevo.csv', 'w', newline='', encoding='utf-8') as csvfile:
    fieldnames = ['review','stars','date']
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    writer.writeheader()
    for item in Jdata:
        writer.writerow(item)
with open('./res/crawling1/jeju_marevo.json', 'w', encoding='utf-8') as jsonfile:
